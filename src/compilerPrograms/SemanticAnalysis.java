...
public class SemanticAnalysis 
{
	...
	public static String isCorrectValue(ArrayList<String> coll_lexemes)
	{
		...
		if(beginning==doub_quote&&last==doub_quote)
		{
			...
			{
				result="Your code is syntactically and semantically correct! "+ new String(Character.toChars(0x2728));//+ new String(Character.toChars(0x1F349))
			}
			else
			{
				result="Your code is syntactically and semantically incorrect! "+new String(Character.toChars(0x1F61E))+new String(Character.toChars(0x2728));
			}
		}
